...
export class Product {
  constructor(
    ...
    if (stock_quantity < 0)
      throw new Error("stock_quantity must be non-negative");
    if (reserved_quantity < 0)
      throw new Error("reserved_quantity must be non-negative");
    if (sold_quantity < 0)
      throw new Error("sold_quantity must be non-negative");
  }
}
...
export function updateProductFromDTO(product: Product, dto: any): Product {
  ...
  product.reserved_quantity =
    dto.reserved_quantity ?? product.reserved_quantity;
...
function validateRequestBody(dto: any) {
  ...
  if (
    ...
    (typeof dto.stock_quantity !== "number" || dto.stock_quantity < 0)
  ) {
    throw new AppError(
  ...
  if (
    dto.reserved_quantity != null &&
    (typeof dto.reserved_quantity !== "number" || dto.reserved_quantity < 0)
  ) {
    throw new AppError(
      "Invalid 'reserved_quantity'",
      400,
  ...
  if (
    dto.sold_quantity != null &&
    (typeof dto.sold_quantity !== "number" || dto.sold_quantity < 0)
  ) {
