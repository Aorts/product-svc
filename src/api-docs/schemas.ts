...
export const CreateProductBody = z.object({
  ...
  description: z.string().min(1).openapi({ example: "This is a sample product." }),
...
export const UpdateProductBody = z.object({
  ...
  description: z.string().min(1).optional().openapi({ example: "This is an updated product description." }),
...
export const StatusSchema = z.object({
  ...
  data: z.any().openapi({ example: { /* example data */ } }),
}).openapi("Status");
